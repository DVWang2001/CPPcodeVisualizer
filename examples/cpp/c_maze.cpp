...
int main() {
    ...
    std::vector<std::vector<int>> grid = {{0, 1, 0, 0}, {0, 1, 0, 1}, {0, 0, 0, 1}}; //@ @guide 這一行要建一座三列四行的迷宮\n0 是通道、1 是牆\n（地圖要等這一行執行完才長出來）@tts [next] 三列四行的迷宮，勾起來的是迷宮配色 @layout sidebar:50 open:container maze:grid
