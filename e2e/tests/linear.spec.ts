...
test('vector: cells show 10, 20, 30 in order', async ({ page }) => {
...
test('vector: Size badge shows Size: 3', async ({ page }) => {
    await expect(
...
test('array: cells show 1, 2, 3 in order', async ({ page }) => {
...
test('string: cells show h and i', async ({ page }) => {
...
test('list: nodes show 4, 5, 6', async ({ page }) => {
...
test('list: harr separators are present between nodes', async ({ page }) => {
    await expect(
